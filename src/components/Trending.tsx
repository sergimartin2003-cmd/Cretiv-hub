        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="#" className="hidden md:flex items-center gap-1.5 text-sm text-violet-400 hover:text-violet-300 transition-colors font-medium">
            ...
            <div className="space-y-3">
              {trending.map((item) => (
                ...
                >
                  ...
                  {/* Icon */}
                  <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-violet-600/25 to-pink-600/25 border border-violet-500/15 flex items-center justify-center text-lg shrink-0">
          ...
          <div className="space-y-5">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={s.label} className="flex items-center justify-between gap-4">
                    <span className="text-sm text-[#8b949e] leading-tight">{s.label}</span>
                    <span className={`text-sm font-bold shrink-0 ${s.color}`}>{s.value}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="gradient-border">
              <div className="bg-[#161b22] rounded-2xl p-5">
                ...
                />
                <button className="w-full btn-gradient py-2.5 rounded-xl text-sm font-bold text-white">
                  Suscribirme gratis
                </button>
