      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button className="relative p-2 text-[#8b949e] hover:text-white hover:bg-white/5 rounded-lg transition-all duration-200">
              <Bell size={17} />
              <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-violet-500 rounded-full" />
            </button>

            <button className="hidden md:block px-3 py-1.5 text-sm text-[#8b949e] border border-[#30363d] rounded-lg hover:border-violet-500/40 hover:text-white transition-all duration-200 font-medium whitespace-nowrap">
              Iniciar sesión
            </button>

            <button className="btn-gradient px-4 py-1.5 text-sm font-bold text-white rounded-lg shadow-lg whitespace-nowrap">
              Empezar
            </button>
        ...
        {menuOpen && (
          <div className="md:hidden glass-dark border-t border-[#30363d]/50 px-4 py-3 space-y-1">
            ...
            <div className="pt-2 border-t border-[#30363d]/50 grid grid-cols-2 gap-2">
              <button className="py-2 text-sm text-[#8b949e] border border-[#30363d] rounded-lg">
                Iniciar sesión
              </button>
              <button className="py-2 text-sm font-bold text-white btn-gradient rounded-lg">
                Empezar gratis
              </button>
            </div>
          </div>
